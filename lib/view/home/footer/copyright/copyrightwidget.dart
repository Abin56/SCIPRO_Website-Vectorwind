...
class CopyRightContainerWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return  Container(
            ...
            child:ResponsiveWebSite.isMobile(context)? Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
              children: [
                Expanded(flex: 2,
                ...
                (
                  ...
                  child: Container(color: cBlack,height: 50,child: Row(children: [
                copyrightContents[0],
                Padding(
                ...
                Expanded(flex: 1,child: Container(color: cBlack,height: 50,child:Row(mainAxisAlignment: MainAxisAlignment.end,
                  children: [  Padding(
                    padding: const EdgeInsets.only(left:10),
                    child:copyrightContents[3]
                  ),
...
List<Widget> copyrightContents =[PrimaryFontWidget(
                    text: "Copyright",
                    fontSize: 12,
                  ...
                  PrimaryFontWidget(
                     ...
                     Image.asset('assets/images/Lepton.png',width: 50,height: 50,),
                  ];