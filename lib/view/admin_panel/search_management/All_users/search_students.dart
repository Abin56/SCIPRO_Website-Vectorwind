...
class AllUsersSearch extends SearchDelegate {
  ...
  Widget buildSuggestions(BuildContext context) {
    final List<StudentProfileCreationModel> suggestionList;

    if (query.isEmpty) {
      suggestionList = Get.find<AllusersController>().studentProfileList;
    } else {
      suggestionList = Get.find<AllusersController>()
          .studentProfileList
          .where(
